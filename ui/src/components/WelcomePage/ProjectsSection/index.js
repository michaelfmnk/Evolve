...
import ProjectImg_1 from 'resources/images/WelcomePage/demo-image-01.jpg'
import ProjectImg_2 from "resources/images/WelcomePage/demo-image-02.jpg"
            ...
            <div className="projects-mid-div">
              <div className="projects-small-div">
                <div className="projects-line-final-text">
                  <h2>Заглавие</h2>
                  <p>Прям очень много слов.Прям очень много слов.Прям очень много слов.Прям очень много слов.Прям очень много
                      слов.</p>
                  <hr/>
                </div>
              </div>
          ...
          <div className="projects-big-div">
            <div className="projects-mid-div">
              <div className="projects-small-div">
                <div className="projects-line-final-text">
                  <h2>Заглавие</h2>
                  <p>Прям очень много слов.Прям очень много слов.Прям очень много слов.Прям очень много
