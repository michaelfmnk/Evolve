...
insert into activities (activity_id, board_id, actor_id, type, recorded_date, data)
values
       (1, 1, 1, 'BOARD_CREATED', now(), '{ "data": "data1" }'),
       (2, 1, 2, 'COLUMN_CREATED', now(), '{ "data": "data2" }'),
       (3, 1, 2, 'COLUMN_CREATED', now(), '{ "data": "data3" }'),
       (4, 2, 1, 'BOARD_CREATED', now(), '{ "data": "data4" }'),
       (5, 2, 2, 'COLUMN_CREATED', now(), '{ "data": "data5" }');
