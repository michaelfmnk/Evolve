...
public class Api {
    ...
    public class Boards {
        ...
        public final String BOARD_COLLABORATORS ="/boards/{board_id}/collaborators";
        ...
        public final String BOARD_CARD_BY_ID = "/boards/{board_id}/columns/{column_id}/cards/{card_id}";
        ...
        public final String BOARD_CARDS_ARCHIVE_CARD = "/boards/{board_id}/columns/{column_id}/cards/{card_id}/archive";
        public final String INVITATION_BY_ID = "/invitations";
    }
